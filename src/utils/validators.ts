...
export const validateOldPassword = () =>
  yup
    .string()
    .min(6, 'validation.password.min')
    .required('validation.password.notnull');

export const validateNewPassword = () =>
  yup.string().matches(noSpaceRegExp, 'no.blank.space');
...
export const validateRequiredCity = () =>
  yup
    ...
    .max(50, 'validation.max.character.city')
...
export const validatePhone = () =>
  yup
    .string()
    .max(12, 'validation.phone.max.digit')
...
export const validateTitleRequired = () =>
  yup.string().required('validation.title.required');

export const validateUrlRequired = () =>
  yup
    .string()
    .required('validation.url.required')
    .matches(globalUrl, 'enter.valid.url');

export const validateSummaryRequired = () =>
  yup.string().required('validation.summary.required');

export const validateStartDateRequired = () =>
  yup.string().required('validation.start.date.required');

export const validateEndDateRequired = () =>
  yup.string().required('validation.end.date.required');

export const validateUploadImageRequired = () =>
  yup.string().required('validation.upload.imagerequired');

export const validatePersonalRequired = (messages?: {
  required?: LocaleString;
  max?: LocaleString;
  inValid?: LocaleString;
}) =>
  yup
    .string()
    .matches(onlyNumber, messages?.inValid || 'validation.value.invalid')
    .required('validation.personal.required');

export const validateAggregateRequired = (messages?: {
  required?: LocaleString;
  max?: LocaleString;
  inValid?: LocaleString;
}) =>
  yup
    .string()
    .matches(onlyNumber, messages?.inValid || 'validation.value.invalid')
    .required('validation.aggregate.required');

export const validateCertificateRequired = () =>
  yup.string().required('validation.certificate.required');
